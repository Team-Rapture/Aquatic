...
public class TeleporterAquatic implements ITeleporter {
    ...
    public static boolean isPosClear(BlockPos pos, World world) {
        ...
        return (!state.getMaterial().isSolid() && state.getMaterial().getPushReaction() != EnumPushReaction.BLOCK) || pos.getY() > world.getHeight(); //failsafe for finding a spawn position
    }
}
