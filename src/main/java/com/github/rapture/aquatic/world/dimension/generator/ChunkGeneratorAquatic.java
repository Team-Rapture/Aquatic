...
public class ChunkGeneratorAquatic implements IChunkGenerator {
    ...
    private final WorldGenPlants coralGenerator0 = new WorldGenPlants(AquaticBlocks.coral_reef_blue);
    private final WorldGenPlants coralGenerator1 = new WorldGenPlants(AquaticBlocks.coral_reef_green);
    ...
    private final WorldGenerator goldGen = new WorldGenMinable(Blocks.GOLD_ORE.getDefaultState(), 4, BlockMatcher.forBlock(AquaticBlocks.AQUATIC_STONE));
    private final WorldGenerator diamonGen = new WorldGenMinable(Blocks.DIAMOND_ORE.getDefaultState(), 3, BlockMatcher.forBlock(AquaticBlocks.AQUATIC_STONE));
    private final WorldGenerator coalGen = new WorldGenMinable(Blocks.COAL_ORE.getDefaultState(), 6, BlockMatcher.forBlock(AquaticBlocks.AQUATIC_STONE));
    ...
    public ChunkGeneratorAquatic(World world) {
        ...
        net.minecraftforge.event.terraingen.InitNoiseGensEvent.ContextHell ctx =
                new net.minecraftforge.event.terraingen.InitNoiseGensEvent.ContextHell(lperlinNoise1, lperlinNoise2, perlinNoise1, slowsandGravelNoiseGen, stoneExculsivityNoiseGen, scaleNoise, depthNoise);
    ...
    public void populate(int x, int z) {
        ...
        if (rand.nextBoolean()) {
            this.coralGenerator0.generate(this.world, this.rand, blockpos.add(this.rand.nextInt(16) + 8, this.rand.nextInt(128), this.rand.nextInt(16) + 8));
            this.coralGenerator1.generate(this.world, this.rand, blockpos.add(this.rand.nextInt(16) + 8, this.rand.nextInt(128), this.rand.nextInt(16) + 8));
        ...
        for (int l1 = 0; l1 < 6; l1++) {
            this.ironGen.generate(this.world, this.rand, blockpos.add(this.rand.nextInt(6), this.rand.nextInt(108) + 10, this.rand.nextInt(6)));
            this.diamonGen.generate(this.world, this.rand, blockpos.add(this.rand.nextInt(6), this.rand.nextInt(108) + 10, this.rand.nextInt(6)));
            this.coalGen.generate(this.world, this.rand, blockpos.add(this.rand.nextInt(6), this.rand.nextInt(108) + 10, this.rand.nextInt(6)));
            this.goldGen.generate(this.world, this.rand, blockpos.add(this.rand.nextInt(6), this.rand.nextInt(108) + 10, this.rand.nextInt(6)));
        }
